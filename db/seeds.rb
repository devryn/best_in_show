...
Dog.create(name: "Lucky", breed: "Yellow Lab", description: "Crazy and fun", img_url: "http://i.imgur.com/DVvMcj6.jpg")
...
Dog.create(name: "Pongo", breed: "Blue Heeler", description: "Likes to play with her bones", img_url: "http://i.imgur.com/nXqqxIV.jpg")
